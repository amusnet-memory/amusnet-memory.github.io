...
async function start() {
    ...
    function showSplash() {
        if(!document.fullscreenElement && typeof document.documentElement.webkitRequestFullscreen == 'function') {
            // safari
    ...
    function onVictory(symbol) {
        ...
        setTimeout(() => {
            const endScreen = new Summary(symbol.src, symbol.prize, startGame);
            game.dispose();
